inherited FrmPenjualan: TFrmPenjualan
        ...
        inherited SMDBGridHeader: TSMDBGrid
          ...
          Columns = <
            ...
            item
              ...
              ReadOnly = True
              Title.Caption = 'CUSTOMER ACCOUNT'
              Width = 115
              Visible = True
            end
            item
  ...
  object frxReport2: TfrxReport
    ...
    ReportOptions.LastChange = 44983.876677928200000000
    ...
    object Page1: TfrxReportPage
      ...
      object Footer1: TfrxFooter
        ...
        object Memo36: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<frxDBDataset2."LINEAMOUNT">,MasterData1,2)]')
          ParentFont = False
        end
        object Memo37: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[(SUM(<frxDBDataset2."LINEAMOUNT">,MasterData1,2)) * 0.11]')
          ParentFont = False
        end
        object Memo38: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[((SUM(<frxDBDataset2."LINEAMOUNT">,MasterData1,2)) * 0.11) + SU' +
              'M(<frxDBDataset2."LINEAMOUNT">)]')
          ParentFont = False
        end
      end
